...
<style>
    ...
    .product-img img {
    width: 100%; /* Đảm bảo ảnh rộng 100% khung */
    height: 300px; /* Chiều cao cố định của khung ảnh */
    object-fit: cover; /* Giữ tỉ lệ ảnh và cắt phần thừa để vừa khung */
    object-position: center; /* Căn giữa nội dung ảnh trong khung */
}

.product-item {
    border: 1px solid #ddd; /* Đường viền nhẹ cho sản phẩm */
...
.product-img {
    position: relative;
    overflow: hidden; /* Ẩn bất kỳ nội dung nào vượt quá khung ảnh */
    border-bottom: 1px solid #ddd; /* Đường viền dưới ảnh */
}

.product-action {
    position: absolute;
    top: 10px; /* Khoảng cách từ trên khung */
    right: 10px; /* Khoảng cách từ phải khung */
    z-index: 10; /* Đặt trên các phần tử khác */
    display: flex;
    gap: 5px;
}
