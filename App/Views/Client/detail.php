    ...
    <div class="row px-xl-5">
        ...
        <div class="col-lg-7 h-auto mb-30">
            <div class="h-100 bg-light p-30">
                ...
                <!-- Thông tin bổ sung -->
                <p><strong>Stock:</strong> <?php echo htmlspecialchars($product_stock); ?> items available</p>
                <p><strong>Created at:</strong> <?php echo htmlspecialchars($product_created_at); ?></p>
            </div>
        </div>
    </div>
</div>
