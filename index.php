...
use App\Controllers\FavoriteProductController;
...
switch ($requestUri) {
    ...
    // Thêm route '/checkout-success' để xử lý trang thanh toán thành công
    case '/checkout-success':
        $CheckoutSuccessController = new App\Controllers\CheckoutSuccessController();
        $CheckoutSuccessController->index();
        break;
    
    case '/favorite-products':
        $favoriteProductController = new App\Controllers\FavoriteProductController();
        $favoriteProductController->index();
        break;
    
        case '/favorite-products/add':
            $favoriteProductController = new App\Controllers\FavoriteProductController();
            $favoriteProductController->addToFavorites();
            break;
    
            case '/favorite-products/remove':
                $favoriteProductController = new App\Controllers\FavoriteProductController();
                $favoriteProductController->removeFromFavorites();
                break;
